...
<head>
  ...
  <title>Daftar Double Barcode</title>
  <!-- Font Awesome -->
...
<body style="background-color:#0c4da2;">
    ...
    <div class="card">
      ...
      <div class="header pt-1  lighten-1" style="background-color:#00a1e4;">
        ...
        <div class="row d-flex justify-content-center">
          <h5 class="white-text mb-3 pt-3 font-weight-bold">Daftar Double Barcode</h5>
      ...
      <div class="text-center mb-3">
          ...
          <!--Twitter-->
          <button type="button" id="daftarscan" class="btn purple-gradient btn-rounded mr-md-3 z-depth-1a font-weight-bold">
          Daftar Scan <i class="fa fa-table white-text"></i></button>
          <!--Google +-->
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function () {
      ...
      // var formattedDate = ("0" + getCurrDate.getDate()).slice(-2) + "-" + ("0" + (getCurrDate.getMonth() + 1)).slice(-2) + "-" + getCurrDate.getFullYear()
      // datepicker.val(formattedDate)

    });


    document.getElementById("daftarscan").onclick = function () {
